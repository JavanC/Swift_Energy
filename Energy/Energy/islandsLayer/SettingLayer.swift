...
class SettingLayer: SKNode {
    ...
    init(frameSize: CGSize) {
        ...
        let settingLabel = SKLabelNode(fontNamed: "SanFranciscoText-BoldItalic")
        ...
        resetButton.position = CGPoint(x: 0, y: gap * -0.5)
